...
{{-- <header>
  <h1>Coach Dashboard - Rembo FC</h1>
</header> --}}
<div class="container">
  
  <div class="coach-info">
      <img src="{{asset('assets/img/coach.jpg')}}" alt="Coach Profile" class="coach-image">
      <div class="coach-details">
          <h2>Head Coach</h2>
          <p>Experience: 10 years</p>
          <p>Specialization: Tactical Training</p>
      </div>
  </div>
  <div class="dashboard-section">
      <h2>Team Statistics</h2>
      <div class="content">
          <div class="item">Matches Played: 50</div>
          <div class="item">Goals Scored: 70</div>
          <div class="item">Goals Conceded: 30</div>
  ...
  {{-- <div class="dashboard-section">
      ...
      <div class="content">
          <div class="item">
              <p>Match Date: August 25, 2023</p>
              <p>Opponent: Team A</p>
              <p>Location: Kayole</p>
          </div>
          <div class="item">
              <p>Match Date: September 1, 2023</p>
              <p>Opponent: Team A</p>
              <p>Location: Umoja</p>
          </div>
      </div>
  ...
  {{-- <div class="dashboard-section">
      ...
      <div class="content">
          <div class="item">
              <p>Subject: Training Schedule</p>
              <p>Message: The training session for this week will be on Wednesday at 4 PM.</p>
          </div>
          <div class="item">
              <p>Subject: Player Update</p>
              <p>Message: Player John Doe will be unavailable for the next match due to injury.</p>
          </div>
      </div>
  </div>
</div> --}}
