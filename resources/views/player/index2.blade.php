...
<div class="page-content">
    ...
    {{-- <header>
      <h1>Player Dashboard - Rembo FC</h1>
  </header> --}}
  <div class="container">
      <div class="player-info">
          <img src="{{asset('assets/img/girl.jpg')}}" alt="Player Profile" class="player-image">
      ...
      <div class="player-stats">
          <div class="stat">Matches Played: 50</div>
          <div class="stat">Goals Scored: 35</div>
          <div class="stat">Assists: 20</div>
          <div class="stat">Yellow Cards: 3</div>
      </div>
      <div class="recent-matches">
        <h2>Recent Matches</h2>
        <div class="match">
            <p>Match Date: August 15, 2023</p>
            <p>Opponent: Team A</p>
            <p>Result: Won (3-1)</p>
        </div>
        <div class="match">
            <p>Match Date: August 10, 2023</p>
            <p>Opponent: Team B</p>
            <p>Result: Draw (2-2)</p>
        </div>
    </div>
